# -*- coding: utf-8 -*-
"""
Created on Wed Jun 19 23:11:25 2024
...
from Model import ANNTest
from utils import train_batch, test, compute_results

#Load dataset
scaler = StandardScaler()
dataset = AcademicDataset(import_path, 'train', transform=scaler)
...
for n_epoch in gridsearch['epoch']:
    for lr in gridsearch['lr']:
        ...
        #Append results
        config_label = "Seed:{}-Epoch:{}".format(seed, n_epoch)
...
compute_results(output_path, final_results_dict, 'Training Output New2')
